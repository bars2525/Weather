...
public class JSONWeatherParser
{
    public  static Weather getWeather(String data)
    {
        ...
        try {
            ...
            weather.currentCondition.setDescription(Utils.getString("discription", jsonWeather));
            weather.currentCondition.setContidition(Utils.getString("main", jsonWeather));
